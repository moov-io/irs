...
var (
	...
	TRecordLayout = map[string]SpecField{
		...
		"CompanyContinuation":          {149, 40, Alphanumeric, Applicable},
		...
		"VendorContactNumber":          {649, 40, Alphanumeric, Required},
		"VendorTelephoneNumber":        {689, 15, TelephoneNumber, Required},
	...
	BRecordLayout = map[string]SpecField{
		...
		"ForeignEntityIndicator":   {246, 1, Alphanumeric, Applicable},
		"FirstPayerNameLine":       {247, 40, Alphanumeric, Required},
		"SecondPayerNameLine":      {287, 40, Alphanumeric, Applicable},
		"Blank2":                   {327, 40, Alphanumeric, Nullable},
		"PayeeMailingAddress":      {367, 40, Alphanumeric, Required},
		"Blank3":                   {407, 40, Alphanumeric, Nullable},
		"PayerCity":                {447, 40, Alphanumeric, Required},
		"PayerState":               {487, 2, Alphanumeric, Required},
		"PayerZipCode":             {489, 9, Numeric, Required},
